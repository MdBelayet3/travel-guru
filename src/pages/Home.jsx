        ...
        <div className="relative h-screen">
            ...
            <div className="relative z-20">
                ...
                <div className="lg:max-w-7xl max-w-[350px] mx-auto">
                    ...
                    <p className='text-white lg:px-40 mb-4'>Travel Guru offers hotel booking, tourist guides, transport, custom tours, and full travel support for a seamless journey experience.</p>

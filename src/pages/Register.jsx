    ...
    return (
        <div className="lg:max-w-xl max-w-[350px] mx-auto my-10">
            <div className='lg:max-w-2xl mx-auto '>
                <form className='border-2 border-gray-300 p-3 lg:px-12 lg:py-8 space-y-5'>
                ...
                <div className='flex justify-center mt-5'>
                    <div className='flex items-center justify-center gap-4 border-2 rounded-3xl px-4 py-2 text-sm lg:text-xl'>
                        <FaFacebook className='text-blue-500' />
                        <p>Continue with Facebook</p>
                    </div>
                </div>
                <div className='flex justify-center mt-5'>
                    <div className='flex items-center justify-center gap-4 border-2 rounded-3xl px-7 py-2 text-sm lg:text-xl'>

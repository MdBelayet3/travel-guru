            ...
            <div className="relative z-20">
                ...
                <div className="lg:max-w-7xl max-w-[350px] mx-auto">
                    ...
                    <div className='lg:flex lg:items-center lg:justify-center'>
                        <img className='mt-10 lg:h-[400px] hover:h-[500px] h-full lg:w-1/2 rounded-lg w-full' src={touristSpot?.image_url} alt="" />
                    </div>
                    <div className='lg:mt-16 mt-10 grid grid-rows-1 lg:grid-cols-2 gap-7 lg:gap-36 rounded-2xl pb-10'>
                        <div className='text-white'>
                            ...
                            <button onClick={() => navigate(-1)} className='btn btn-warning mt-5'>Go Home</button>
                        </div>
                        <div className='p-6 bg-white text-black flex flex-col gap-3 rounded-2xl'>
                            ...
                            <Link to={`/tourist/${touristSpot?.id}/booking`} className='btn w-full p-5 bg-orange-500 hover:bg-orange-300'>Start Booking</Link>
                        </div>
                    </div>
